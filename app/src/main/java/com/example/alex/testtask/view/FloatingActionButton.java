package com.example.alex.testtask.view;
...
public class FloatingActionButton extends View {
    ...
    public void setFloatingActionButtonDrawable(Drawable FloatingActionButtonDrawable) {
        if (FloatingActionButtonDrawable instanceof BitmapDrawable) {
            ...
            Bitmap bitmap = Bitmap.createBitmap(FloatingActionButtonDrawable.getIntrinsicWidth(),
                    FloatingActionButtonDrawable.getIntrinsicHeight(),
